...
function generateCartItems(cartItems) {
    ...
    cartItems.forEach((item) => {
        ...
        <div class="cart-item-counter w-48 flex items-center ">
            ...
            <div data-id="${item.id}" class="cart-item-increase cursor-pointer text-gray-400 bg-gray-100 rounded h-6 w-6 flex justify-center items-center hover:bg-gray-200 ml-2">
